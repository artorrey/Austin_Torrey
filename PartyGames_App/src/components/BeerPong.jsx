...
class BeerPong extends React.Component {
    constructor() {
        super();
    ...
    getGames() {
        const beerPongMatches = [];
        axios.get('http://localhost:3001/api/games')
            .then(res => {
                this.setState({ games: res.data });
                for (var i=0; i < res.data.length; i++ ){
                    if (res.data[i].game === "beerpong"){
                        beerPongMatches.push(res.data[i]);
                        this.setState({ beerPongMatches })
                        for (var j=0; j < beerPongMatches.length; j++) {
                            if (beerPongMatches[j].match === 1) {
                                if (beerPongMatches[j].winner === "team1") {
                                    this.setState ({
                                        match1winner: "team1",
                                        match1Ended: true
                                    })
                                } else if (beerPongMatches[j].winner === 'team2') {
                                    this.setState ({
                                        match1winner: "team2",
                                        match1Ended: true
                                    })
                            ...
                            } else if (beerPongMatches[j].match === 2) {
                                if (beerPongMatches[j].winner === "team1") {
                                    this.setState({
                                        match2winner: "team1",
                                        match2Ended: true
                                    })
                                } else if (beerPongMatches[j].winner === 'team3') {
                                    this.setState({
                                        match2winner: "team3",
                                        match2Ended: true
                                    })
                            ...
                            } else if (beerPongMatches[j].match === 3) {
                                if (beerPongMatches[j].winner === "team2") {
                                    this.setState({
                                        match3winner: "team2",
                                        match3Ended: true
                                    })
    ...
    handleClick = (e, pl1, pl2) => {
        e.preventDefault;
        this.updateScore(pl1);
        this.updateScore(pl2);
    };
    ...
    endMatch1Team1 = () => {
        ...
        this.saveGame('5a4c3c36e5cea66bca8609aa', 'team1');
        this.updateScore(WM);
        this.updateScore(AT);
    ...
    endMatch1Team2 = () => {
        ...
        this.saveGame('5a4c3c36e5cea66bca8609aa', 'team2');
        this.updateScore(KH);
        this.updateScore(JM)
    ...
    endMatch2Team1 = () => {
        ...
        this.saveGame('5a4c3c43e5cea66bca8609ac', 'team1');
        this.updateScore(WM);
        this.updateScore(AT);
    ...
    endMatch2Team3 = () => {
        ...
        this.saveGame('5a4c3c43e5cea66bca8609ac', 'team3');
        this.updateScore(DK);
        this.updateScore(ML);
    ...
    endMatch3Team2 = () => {
        ...
        this.saveGame('5a4c3c49e5cea66bca8609ad', 'team2');
        this.updateScore(KH);
        this.updateScore(JM);
    ...
    endMatch3Team3 = () => {
        ...
        this.saveGame('5a4c3c49e5cea66bca8609ad', 'team3');
        this.updateScore(DK);
        this.updateScore(ML);
    ...
    render(){
        ...
        return(
            <div className="GamePage">
                ...
                (
                    <div id="FlipM1">
                        <h2 className="BPmatch">Match 1</h2>

                        <div className="row">
                            <div className="col-sm-2">
                            <img className="BPlogo" src={ require ("../img/beer-pong-1.png")}/>
                        </div>
                            <div className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, WM, AT); this.endMatch1(e);}}
                            ...
                            <div id="right-col" className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, KH, JM); this.endMatch1(e);}}
                ...
                (
                    <div id="FlipM2">
                        <h2 className="BPmatch">Match 2</h2>
                        <div className="row">
                            <div className="col-sm-2">
                                <img className="BPlogo" src={ require ("../img/beer-pong-1.png")}/>
                            </div>
                            <div className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, WM, AT); this.endMatch2(e);}}
                            ...
                            <div id="right-col" className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, ML, DK); this.endMatch2(e);}}
                ...
                (
                    <div id="FlipM3">
                        <h2 className="BPmatch">Match 3</h2>
                        <div className="row">
                            <div className="col-sm-2">
                                <img className="BPlogo" src={ require ("../img/beer-pong-1.png")}/>
                            </div>
                            <div className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, KH, JM); this.endMatch3(e);}}
                            ...
                            <div id="right-col" className="col-sm-4">
                                <button
                                    className="btn btn-primary"
                                    // onClick={(e) => {this.handleClick(e, ML, DK); this.endMatch3(e);}}
